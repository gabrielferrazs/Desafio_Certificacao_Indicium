...
,   joined as (
        ...
        left join stateprovince on
            address.fk_state_province = stateprovince.pk_state_province
        left join countryregion on
            stateprovince.fk_country_region_code = countryregion.pk_country_region_code
        left join salesterritory on
            stateprovince.fk_territory = salesterritory.pk_territory
